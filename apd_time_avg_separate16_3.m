...
while count <= total
    ...
    try
        ...
        coravg90 = corr(avg90,RR);
        corstd90 = corr(std90,RR);
        coravg80 = corr(avg80,RR);
        corstd80 = corr(std80,RR);
        coravg50 = corr(avg50,RR);
        corstd50 = corr(std50,RR);
        coravg30 = corr(avg30,RR);
        corstd30 = corr(std30,RR);
        coravgUp = corr(avgUp,RR);
        corstdUp = corr(stdUp,RR);
        coravgSize = corr(avgSize,RR);
        corstdSize = corr(stdSize,RR);
        corpeakDuration = corr(peakDuration,RR);
        corstd_peakDuration = corr(std_peakDuration,RR);
