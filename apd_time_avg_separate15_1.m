function apd_time_avg_separate15_1(method,num)
%Default function call:     apd_time_avg_separate15_1('amp',20)
...
%     averagepixel = averagepixel1(51:length(averagepixel1)-50);
    ...
    try
        ...
        save([dirname delim filenamemethnum '_originaltrace.mat'],'averagepixel','time');
        ...
        save([newdirname delim filenamenulmethnum '_originaltrace.mat'],'averagepixel','time');
